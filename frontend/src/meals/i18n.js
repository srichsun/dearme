...
export const STRINGS = {
  ...
  rewards: { zh: "激勵影片", en: "Reward clips" },
  rewardsHint: { zh: "今天全部做到的那一刻會跳出來。從相簿選影片上傳，25MB 內。", en: "Plays the moment the whole list is ticked. Pick a video from your photos, under 25MB." },
