...
export const STRINGS = {
  ...
  photoMeal: { zh: "食物照", en: "Food photo" },
  photoLabel: { zh: "營養標示照", en: "Label photo" },
  photoHint: { zh: "拍照或從圖庫選都可以。食物照會估份量；標示照直接讀數字。", en: "Camera or library. A food photo gets portions estimated; a label photo is read as printed." },
  ...
  fromBrand: { zh: "餐廳標示", en: "brand" },
  fromSaved: { zh: "我的資料", en: "saved" },
  myFoods: { zh: "我的食物資料", en: "My foods" },
  myFoodsHint: { zh: "標示照和餐廳標示記下來時會自動存進來，下次直接用。", en: "Labels and brand tables are kept here when you log them, and reused next time." },
  noFoods: { zh: "還沒有。", en: "None yet." },
  per100: { zh: "每 100g", en: "per 100 g" },
  less: { zh: "少一點", en: "Less" },
  more: { zh: "多一點", en: "More" },
